...
const styles = StyleSheet.create({
  ...
  countText:    { fontSize: 11, fontWeight: "700", fontFamily: "Inter_700Bold" } as TextStyle,
  ...
  searchText:   { flex: 1, fontSize: 13, fontFamily: "Inter_400Regular" } as TextStyle,
  cancelBtn:    { paddingHorizontal: 4 } as ViewStyle,
  cancelText:   { fontSize: 13, fontWeight: "700", fontFamily: "Inter_700Bold" } as TextStyle,
  trendingWrap: { borderBottomWidth: 1, paddingHorizontal: 18, paddingTop: 12, paddingBottom: 10 } as ViewStyle,
  trendingLabel:{ fontSize: 10, fontWeight: "700", letterSpacing: 1.2, fontFamily: "Inter_700Bold", marginBottom: 8 } as TextStyle,
  ...
  trendText:    { fontSize: 12, fontFamily: "Inter_400Regular" } as TextStyle,
  resultCount:  { fontSize: 12, fontFamily: "Inter_400Regular", paddingBottom: 8 } as TextStyle,
  ...
  rowTitle:     { fontSize: 13, fontWeight: "700", fontFamily: "Inter_700Bold", marginBottom: 3 } as TextStyle,
  rowMeta:      { fontSize: 11, fontFamily: "Inter_400Regular" } as TextStyle,
  ...
  emptySub:     { fontSize: 13, fontFamily: "Inter_400Regular", textAlign: "center", maxWidth: 240 } as TextStyle,
