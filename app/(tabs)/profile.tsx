...
const styles = StyleSheet.create({
  ...
  headerLabel:   { fontSize: 10, fontWeight: "700", letterSpacing: 1.2, fontFamily: "Inter_700Bold" } as TextStyle,
  ...
  nameInput:     { borderWidth: 2, borderRadius: 10, fontSize: 15, padding: 9, fontFamily: "Inter_700Bold" } as TextStyle,
  ...
  saveBtnText:   { fontSize: 13, fontWeight: "700", fontFamily: "Inter_700Bold" } as TextStyle,
  cancelBtn:     { flex: 1, borderWidth: 2, borderRadius: 10, padding: 8, alignItems: "center" } as ViewStyle,
  cancelBtnText: { fontSize: 13, fontFamily: "Inter_400Regular" } as TextStyle,
  nameRow:       { flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 3 } as ViewStyle,
  username:      { fontSize: 17, fontWeight: "800", fontFamily: "Inter_700Bold" } as TextStyle,
  editPill:      { borderWidth: 1, borderRadius: 10, paddingHorizontal: 7, paddingVertical: 1 } as ViewStyle,
  editPillText:  { fontSize: 11, fontWeight: "600", fontFamily: "Inter_700Bold" } as TextStyle,
  email:         { fontSize: 13, fontFamily: "Inter_400Regular" } as TextStyle,
  authBadge:     { fontSize: 11, fontFamily: "Inter_700Bold", marginTop: 2 } as TextStyle,
  ...
  pickerLabel:   { fontSize: 10, fontWeight: "700", letterSpacing: 1, textTransform: "uppercase", fontFamily: "Inter_700Bold", marginBottom: 10 } as TextStyle,
  ...
  areaLabel:     { fontSize: 10, fontWeight: "600", letterSpacing: 1, textTransform: "uppercase", fontFamily: "Inter_700Bold" } as TextStyle,
  ...
  areaValue:     { fontSize: 15, fontWeight: "700", fontFamily: "Inter_700Bold" } as TextStyle,
  activeBadge:   { fontSize: 11, fontFamily: "Inter_700Bold" } as TextStyle,
  ...
  changeBtnText: { fontSize: 12, fontWeight: "700", fontFamily: "Inter_700Bold" } as TextStyle,
  sectionLabel:  { fontSize: 11, fontWeight: "700", letterSpacing: 1.2, textTransform: "uppercase", fontFamily: "Inter_700Bold", marginBottom: 10 } as TextStyle,
  ...
  notifLabel:    { fontSize: 13, fontWeight: "600", fontFamily: "Inter_700Bold" } as TextStyle,
  notifSub:      { fontSize: 11, fontFamily: "Inter_400Regular", marginTop: 2 } as TextStyle,
  ...
  healthText:       { fontSize: 11, fontFamily: "Inter_400Regular", lineHeight: 16 } as TextStyle,
  ...
  segmentLabel:     { fontSize: 12, fontWeight: "700", fontFamily: "Inter_700Bold", letterSpacing: 0.3 } as TextStyle,
});
