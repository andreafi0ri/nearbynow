...
const styles = StyleSheet.create({
  ...
  catLabel:      { fontSize:10, fontWeight:"700", letterSpacing:1, textTransform:"uppercase", fontFamily:"DMSans_700Bold" } as TextStyle,
  nearbyBadge:   { borderWidth:1, borderRadius:10, paddingHorizontal:6, paddingVertical:1 } as ViewStyle,
  nearbyText:    { fontSize:9, fontWeight:"700", letterSpacing:1, textTransform:"uppercase", fontFamily:"DMSans_700Bold" } as TextStyle,
  saveBtn:       { borderWidth:1.5, borderRadius:20, paddingHorizontal:10, paddingVertical:4 } as ViewStyle,
  title:         { fontSize:17, fontWeight:"800", lineHeight:22, marginBottom:6, fontFamily:"PlayfairDisplay_800ExtraBold" } as TextStyle,
  ratingRow:     { flexDirection:"row", alignItems:"center", gap:4, marginBottom:6 } as ViewStyle,
  stars:         { fontSize:12 } as TextStyle,
  ratingNum:     { fontSize:12, fontWeight:"700", fontFamily:"DMSans_700Bold" } as TextStyle,
  reviewCount:   { fontSize:11, fontFamily:"DMSans_400Regular" } as TextStyle,
  desc:          { fontSize:13, lineHeight:20, marginBottom:12, fontFamily:"DMSans_400Regular" } as TextStyle,
  ...
  showingText:   { fontSize:12, fontWeight:"600", fontFamily:"DMSans_600SemiBold" } as TextStyle,
  ...
  metaTime:      { fontSize:13, fontWeight:"600", fontFamily:"DMSans_600SemiBold" } as TextStyle,
  metaDate:      { fontSize:12, fontFamily:"DMSans_400Regular" } as TextStyle,
  metaLoc:       { fontSize:12, fontFamily:"DMSans_400Regular", marginTop:2 } as TextStyle,
  showTimesWrap: { flex:1, gap:4 } as ViewStyle,
  showTimesLabel:{ fontSize:9, fontWeight:"700", letterSpacing:1.1, textTransform:"uppercase", fontFamily:"DMSans_700Bold" } as TextStyle,
  ...
  showTimeText:  { fontSize:12, fontWeight:"600", fontFamily:"DMSans_600SemiBold" } as TextStyle,
  footer:        { flexDirection:"row", justifyContent:"space-between", alignItems:"center" } as ViewStyle,
  saves:         { fontSize:11, fontFamily:"DMSans_400Regular" } as TextStyle,
  ...
  bookBtnText:   { fontSize:12, fontWeight:"700", fontFamily:"DMSans_700Bold" } as TextStyle,
  ...
  viewBtnText:   { fontSize:12, fontWeight:"600", fontFamily:"DMSans_600SemiBold" } as TextStyle,
  ...
  sheetLabel:    { fontSize:11, fontWeight:"700", letterSpacing:1.2, textTransform:"uppercase", fontFamily:"DMSans_700Bold", marginBottom:4 } as TextStyle,
  sheetTitle:    { fontSize:16, fontWeight:"800", fontFamily:"PlayfairDisplay_800ExtraBold", lineHeight:22, marginBottom:4 } as TextStyle,
  sheetMeta:     { fontSize:12, fontFamily:"DMSans_400Regular", marginBottom:14 } as TextStyle,
  ...
  calOptionTitle:{ fontSize:14, fontWeight:"700", fontFamily:"DMSans_700Bold", marginBottom:2 } as TextStyle,
  calOptionSub:  { fontSize:12, fontFamily:"DMSans_400Regular" } as TextStyle,
  cancelBtn:         { borderWidth:2, borderRadius:14, padding:12, alignItems:"center", marginTop:4 } as ViewStyle,
  cancelText:        { fontSize:13, fontWeight:"600", fontFamily:"DMSans_600SemiBold" } as TextStyle,
  ...
  mergedPillText:    { fontSize:10, fontWeight:"700", fontFamily:"DMSans_700Bold", letterSpacing:0.5, textTransform:"uppercase" } as TextStyle,
  ...
  cancelledText:     { fontSize:12, fontWeight:"700", fontFamily:"DMSans_700Bold" } as TextStyle,
  // Multi-source link strip
  sourceLinksSection:{ borderTopWidth:1.5, paddingTop:10, marginBottom:12, gap:8 } as ViewStyle,
  sourceLinksLabel:  { fontSize:10, fontWeight:"700", letterSpacing:1, textTransform:"uppercase", fontFamily:"DMSans_700Bold" } as TextStyle,
  ...
  sourceLinkText:    { fontSize:11, fontWeight:"700", fontFamily:"DMSans_700Bold" } as TextStyle,
});
