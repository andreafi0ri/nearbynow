              ...
              {(() => {
                ...
                return (
                  <Text style={[styles.areaText, { color: T.text }]} numberOfLines={1}>
                    {city}
                    {state ? (
                      <Text style={{ fontFamily: "Inter_600SemiBold_Italic", color: T.gold }}>{", " + state}</Text>
                    ) : null}
                  </Text>
                );
              })()}
...
const styles = StyleSheet.create({
  ...
  browsingLabel:  { fontSize: 10, fontWeight: "600", letterSpacing: 1.2, fontFamily: "Inter_700Bold" } as TextStyle,
  areaBtn:        { flexDirection: "row", alignItems: "center", gap: 7, marginTop: 2 } as ViewStyle,
  areaText:       { fontSize: 19, fontWeight: "800", fontFamily: "Inter_700Bold" } as TextStyle,
  changePill:     { borderWidth: 1.5, borderRadius: 10, paddingHorizontal: 8, paddingVertical: 2 } as ViewStyle,
  changeText:     { fontSize: 10, fontWeight: "700", fontFamily: "Inter_700Bold" } as TextStyle,
  ...
  notifBadgeText: { fontSize: 9, fontWeight: "700", color: "#FFFFFF", fontFamily: "Inter_700Bold" } as TextStyle,
  radiusLabel:    { fontSize: 10, fontFamily: "Inter_400Regular", marginTop: 2, letterSpacing: 0.2 } as TextStyle,
  // ── 3-pill bar ──────────────────────────────────────────────────────────
  ...
  resultCount:    { fontSize: 11, fontFamily: "Inter_700Bold", fontWeight: "700", letterSpacing: 0.6, textTransform: "uppercase", paddingBottom: 10 } as TextStyle,
  ...
  seeAllTitle:        { fontFamily: "Inter_700Bold", fontSize: 20, letterSpacing: -0.2 } as TextStyle,
  ...
  dividerText:    { fontSize: 11, fontWeight: "700", fontFamily: "Inter_700Bold", letterSpacing: 0.6, textTransform: "uppercase" } as TextStyle,
  ...
  remoteLoaderText:   { fontSize: 12, fontFamily: "Inter_400Regular" } as TextStyle,
  ...
  areaSwitcherText:   { fontSize: 13, fontFamily: "Inter_400Regular", flex: 1 } as TextStyle,
});
